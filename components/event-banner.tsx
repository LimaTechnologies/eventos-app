...
export function EventBanner({ event, showCountdown = false }: EventBannerProps) {
  ...
  return (
    <>
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-blue-600 via-purple-600 to-pink-600 text-white shadow-xl w-full max-h-[60%] pb-5">
